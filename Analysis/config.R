...
syncFolder <- "/home/kresimir/Dropbox/Work/Projects/BenchmarkDP/formatanalysis/figures and other material/201605 figures and other material/201605201900/models"

colNames <- c("server", "tika", "droid", "year", "amount")


 experiments <- c("IMAGES-3")
