...
syncFolder <- "/home/kresimir/Dropbox/Work/Projects/BenchmarkDP/formatanalysis/figures and other material/201605 figures and other material/201605181000/models"

colNames <- c("server", "tika", "droid", "year", "amount")


experiments <- c("DOCUMENTS-2-TESTPEAK")
