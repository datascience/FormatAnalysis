...
# text(4,2.7, labels="Bass curve", adj = c(0,0), cex = 1.5)
# arrows(3.9,2.75,x[50]+0.1,y[50]+0.001,length=0.15,angle=30, lwd = 2)
# text(6,0.5, labels="External influence\ninnovators (p = 0.1)", adj = c(0,0), cex = 1.5)
# arrows(7.9,0.45,x[70]-0.5,yp[70]-0.01,length=0.15,angle=30, lwd = 2)
# text(5.5,1.8, labels="Internal influence\nimitators (q = 0.9)", adj = c(0,0), cex = 1.5)
# arrows(5.9,1.75,x[70]-0.5,yq[70]-0.01,length=0.15,angle=30, lwd = 2)
